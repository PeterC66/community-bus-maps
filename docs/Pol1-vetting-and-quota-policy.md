...
<!-- docstamp v1.3 | 2026-09-04 | sha=915556d9 -->
**v1.3** · updated 4 September 2026
...
Every application → **one line** in the private vetting decisions log: the authority check, the decision (approve / hold / decline) and the reason. This is the audit of *judgement* that the database doesn't hold — keep it current.
