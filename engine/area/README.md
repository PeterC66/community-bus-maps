...
<!-- docstamp v1.1 | 2026-08-26 | sha=dc0656f4 -->
**v1.1** · updated 26 August 2026
...
- `gen_external_radial.js`, `gen_external_busway.js` — the two external templates. The payload's `gen_external.js` is a renamed copy of one of them; every town in the tree currently plays back as **radial**, and that is the default. Override with `--external-style busway`.
