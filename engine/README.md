...
**The per-map generators (`gen_internal.js`, `gen_external.js`, …) are NOT vendored here.** They are customised per area/place and travel *with each map's data* in the object store (not in this repo). A generator is env/flag driven:
